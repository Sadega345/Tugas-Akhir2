...
insert  into `mst_standar`(`standar_id`,`standar_name`,`description`) values (3,'Standar 3',NULL),(4,'Standar 4',NULL),(5,'Standar 5',NULL),(6,'Standar 6',NULL),(7,'Standar 7',NULL);
