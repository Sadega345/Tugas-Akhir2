...
class Posisi extends AUTH_Controller {
	...
	public function index() {
		...
		$data['page'] 		= "instrumen";
		$data['judul'] 		= "Data Instrumen";
		$data['deskripsi'] 	= "Manage Data Instrumen";

		$data['modal_tambah_instrumen'] = show_my_modal('modals/modal_tambah_instrumen', 'tambah-posisi', $data);
