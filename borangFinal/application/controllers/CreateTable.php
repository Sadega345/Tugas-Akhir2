...
class CreateTable extends AUTH_Controller {
	public function __construct() {
		parent::__construct();
		$this->load->model('M_CreateTable');
	}
	...
	public function index() {
		...
		$data['judul'] = "Master Data Table";
		$data['deskripsi'] = "Master Data Table";
		$data['dataAsalButir'] = $this->M_CreateTable->select_mstbutir();
		$data['dataTable'] = $this->M_CreateTable->select_historistable();
		$data['modal_tambah_createTable'] = show_my_modal('modals/modal_tambah_createTable', 'tambah-createTable', $data);

		$this->template->views('CreateTable/home', $data);
	}

	public function tampil() {
		$data['dataCreateTable'] = $this->M_CreateTable->select_historistable();
		
		$this->load->view('CreateTable/list_data', $data);
	}
	...
	public function prosesTambah() {
		...
		if ($this->form_validation->run() == TRUE) {
			$result = $this->M_CreateTable->insert($data);
	...
	public function delete() {
		$id = $_POST['id'];
		$result = $this->M_CreateTable->delete($id);
