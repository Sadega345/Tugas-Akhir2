<div class="col-md-offset-1 col-md-10 col-md-offset-1 well">
  ...
  <h3 style="display:block; text-align:center;">Update Data Fakultas</h3>
      <form method="POST" id="form-update-manageFakultas">
        <input type="hidden" name="id" value="<?php echo $dataManageFakultas->faculty_id; ?>">
        <!-- Nama Standar -->
        <div class="input-group form-group">
          <span class="input-group-addon" id="sizing-addon2">
            <i class="glyphicon glyphicon-user"></i>
          </span>
          <input type="text" class="form-control" placeholder="Nama Fakultas" name="nmfakultas" aria-describedby="sizing-addon2" value="<?php echo $dataManageFakultas->faculty_name; ?>">
        </div>
