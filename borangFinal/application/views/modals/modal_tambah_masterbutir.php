<div class="col-md-offset-1 col-md-10 col-md-offset-1 well">
  ...
  <form id="form-tambah-masterButir" method="POST">
    <!-- Standar -->
    <div class="input-group form-group">
      <span class="input-group-addon" id="sizing-addon2">
        <i class="glyphicon glyphicon-user"></i>
      </span>
      <select name="nmstandar" class="form-control " aria-describedby="sizing-addon2">
    ...
    <div class="input-group form-group">
      ...
      <input type="text" class="form-control" placeholder="Nama Butir" name="namabutir" aria-describedby="sizing-addon2">
    </div>
