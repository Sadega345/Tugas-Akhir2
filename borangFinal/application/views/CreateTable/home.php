...
<div class="box">
  <div class="box-header">
    <div class="col-md-6" style="padding: 0;">
        <button class="form-control btn btn-primary" data-toggle="modal" data-target="#tambah-createTable"><i class="glyphicon glyphicon-plus-sign"></i> Tambah Data</button>
    </div>
    <div class="col-md-3">
...
<?php echo $modal_tambah_createTable; ?>

<div id="ubah-createTable"></div>

<?php show_my_confirm('konfirmasiHapus', 'hapus-dataTable', 'Hapus Data Ini?', 'Ya, Hapus Data Ini'); ?>
<!-- <?php
  $data['judul'] = 'User';
